...
function main(){
	...
	function saveLayer(layer, lname, path, shouldMerge) {
		...
		SavePNG(saveFile);
		activeDocument.resizeImage(undefined,undefined, app.activeDocument.resolution * 3, ResampleMethod.BICUBICSHARPER);
	    saveFile= File(path +"/"+outFolderName+"/"+lname+"@3x.png");
		SavePNG(saveFile);	
